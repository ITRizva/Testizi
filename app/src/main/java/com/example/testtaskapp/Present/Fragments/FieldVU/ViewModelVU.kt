...
@HiltViewModel
class ViewModelVU @Inject constructor(private val savedStateHandle: SavedStateHandle,private val saveRegisterDataUseCase: SaveRegisterDataUseCase):ViewModel() {
